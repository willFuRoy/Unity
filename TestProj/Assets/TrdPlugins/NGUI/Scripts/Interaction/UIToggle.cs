...
public sealed class UIToggle : UIWidgetContainer
{
	/// <summary>
	...
	public void Set (bool state)
	{
		...
		else if (mIsActive != state)
		{
            ...
            // llm: 2017-10-17不进行 Current 判断，让 Toggle 能递归执行
            //if (current == null)
            {
				...
				if (EventDelegate.IsValid(onChange))
				{
                    ...
                    // add by llm 2017-12-7
                    //SendMessage("OnToggled", SendMessageOptions.DontRequireReceiver);
                }
				else if (eventReceiver != null && !string.IsNullOrEmpty(functionName))
				{
                    ...
                    // add by jinghong 2016-11-12
                    //SendMessage("OnToggled", SendMessageOptions.DontRequireReceiver);
                }

                // add by llm 2017-12-14
                //SendMessage("OnToggled", SendMessageOptions.DontRequireReceiver);
