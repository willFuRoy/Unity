...
public class UIProgressBar : UIWidgetContainer
{
	...
	//By Zsy : mSizeValue从计算上等同于value，但是控制方式为修改scale而不是uisprite的fillamount，用以避免触发频繁的onfill操作
	Vector3 mSizeValue = Vector3.one;
	public void SetValueBySize(float val)
	{
		mSizeValue.x = val;
		foregroundWidget.cachedTransform.localScale = mSizeValue;
	}
}
