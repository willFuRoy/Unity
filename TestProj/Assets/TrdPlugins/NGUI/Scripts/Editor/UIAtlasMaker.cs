...
{
    public static bool gAtlasWindowOpended { get; private set; }
	...
	static public void UpdateAtlas (UIAtlas atlas, List<SpriteEntry> sprites)
	{
		if (sprites.Count > 0)
		{
            ...
            // 分离贴图
            if (NGUISettings.atlasSplit) {
                //UIAtlasMakerExt.SplitAtlasTexture();
            }
    ...
    private void OnGUI() {
        ...
        GUILayout.BeginHorizontal();
        NGUISettings.atlasSplit = EditorGUILayout.Toggle("Split Texture", NGUISettings.atlasSplit, GUILayout.Width(100f));
        GUILayout.Label("RGB/A 分离");
        GUILayout.EndHorizontal();
