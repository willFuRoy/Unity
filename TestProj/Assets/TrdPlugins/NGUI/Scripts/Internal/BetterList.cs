...
public class BetterList<T>
{
	...
	/// <summary>
	/// to allocate memery by a certain count of item, avoid to allocate many times. this func is added by Zsy
	/// </summary>
	public void AllocateMoreByCount(int count)
	{
		if (buffer == null || (buffer != null && buffer.Length - size < count)) {
			int len = buffer == null ? count : (count + size);
			T[] newList = new T[len];
			if(buffer != null)
